...
Unter **Verpflegung** wechselst du direkt zwischen **Essensplan** und **Rezepte**. Dort stehen die
veranstalterweite Rezeptbibliothek und die Mahlzeiten der geöffneten Freizeit
nebeneinander. Bibliotheksrezepte gehören der gesamten Organisation; Mahlzeiten und ihre Rezept-Snapshots gehören
zum Camp.

## Rezept anlegen

Organisationsadmins wählen **Rezept anlegen** und erfassen Name, Beschreibung, Zubereitung und
...
Zutatenmengen, Ernährungs-Tags sowie Allergen- und Küchenhinweise. Organisationsadmins können anschließend
...
100-MiB-Rezeptbibliotheksquote. Organisationsadmins können PDF-, JPEG-, PNG- oder WebP-Dateien bis
...
Organisationsadmins öffnen **Zutaten verwalten**. Neue Namen werden vereinheitlicht; Schreibweise,
