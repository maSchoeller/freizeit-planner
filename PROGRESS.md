...
| A01 activity/trash                    | in_progress | Metadata-only feed, soft delete/restore and deterministic 30-day purge                      | Shopping-item hard delete bypassed trash               | 19 Logistics + 4 Cleanup + PostgreSQL cleanup green  | Logistics context, search/activity help   | pending   | add remaining domain trash lifecycles  |
