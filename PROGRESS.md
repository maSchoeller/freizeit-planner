...
| C01 camps                             | in_progress | Camp lifecycle, slugs, archive read-only/reactivate, dashboard                              | Hard-coded workspace IDs ignored speaking routes       | 17 Camps, 29 API, 24 React + browser green           | Camps context, organization/camp help     | pending   | replace static dashboard data          |
