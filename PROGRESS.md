...
| L02 shopping                          | in_progress | Named lists, unified sourced items, editable transfer, concurrent check-off and polling     | Hard delete removed individual items immediately       | 19 Logistics + reviewed transfer UI/browser          | Logistics context, recipe help            | pending   | replace static list/check-off UI       |
