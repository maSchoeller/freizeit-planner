...
| A01 activity/trash                    | in_progress | Metadata-only feed, soft delete/restore and deterministic 30-day purge                      | Direct restore accepted Member permissions             | 13 Activity + 20 API + 13 React tests green          | Activity context, search/activity help    | pending   | add soft lifecycle to remaining domain objects |
