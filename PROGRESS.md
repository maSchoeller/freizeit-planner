...
| C02 schedule                          | in_progress | Agenda/calendar CRUD, overlap, timezone/DST, all-day, ETag, atomic links                    | Hard delete removed entries immediately                | 17 Camps + 23 API + PostgreSQL cleanup green         | Camps context, schedule/help              | pending   | implement atomic linked create         |
...
| T02 meals and snapshots               | in_progress | Portion scaling, stable/refreshable snapshots and atomic schedule workflow                  | Hard delete removed meals immediately                  | 11 Catering + 23 API + PostgreSQL cleanup green      | Catering context, help                    | pending   | implement atomic linked create         |
