...
| UX01 shared application shell         | verified    | Dynamic authorized landing, contextual header and direct role-aware administration navigation   | Root still entered seeded Camp; contextual administration links were absent         | 13 targeted React tests, lint and TypeScript strict green | Identity/help                             | pending   | Start UX02 authentication/account    |
| UX02 authentication and account       | pending     | Shared authentication shell, conditional First Login, safe return route and sectioned account   | pending                                                                             | pending                                                   | Identity/help                             | pending   | Complete UX01                        |
