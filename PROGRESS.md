...
| UX03 administration workspace         | in_progress | Persistent platform/organization navigation, focused user details and safe invitation dialogs   | Platform navigation and focused user/invitation interactions were absent            | pending                                                   | Identity/help                             | pending   | Implement administration workspace  |
| UX04 camp navigation                  | pending     | Grouped desktop navigation, compact mobile navigation and separated planning subareas           | pending                                                                             | pending                                                   | product/help                              | pending   | Complete UX03                        |
| UX05 visual consolidation             | pending     | Shared tokens, responsive tables/dialogs, route focus and complete accessible Chrome inspection | pending                                                                             | pending                                                   | all affected help                         | pending   | Complete UX04                        |
