...
| K01 notebook                          | in_progress | Shared pinned/tagged notes with safe rendered Markdown                                      | Notiz anlegen exposed no title field                   | 13 Knowledge, 45 React + full gate/browser           | Knowledge context, notebook/file help     | pending   | Edit, typed links, trash, private files |
