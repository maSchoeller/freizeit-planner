...
| UX02 authentication and account       | verified    | Shared authentication shell, conditional First Login, safe return route and sectioned account   | First Login stayed visible; return target and account subsection routes were ignored | 110 React tests, lint and TypeScript strict green         | Identity and four help pages               | pending   | Start UX03 administration            |
| UX03 administration workspace         | pending     | Persistent platform/organization navigation, focused user details and safe invitation dialogs   | pending                                                                             | pending                                                   | Identity/help                             | pending   | Complete UX02                        |
