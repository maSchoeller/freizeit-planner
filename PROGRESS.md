...
| K01 notebook                          | in_progress | Shared notes with typed links, lifecycle and private attachments                            | Note detail exposed no private file region             | 13 Knowledge, 28 Files, 48 React + full gate/browser | Knowledge/Files contexts, notebook help   | pending   | Complete Camp trash restore journey    |
