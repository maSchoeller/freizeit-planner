...
| A01 activity/trash                    | in_progress | Metadata-only feed, soft delete/restore and deterministic 30-day purge                      | Material hard delete bypassed trash                    | 13 Activity + 21 API + 13 React tests green          | Activity context, search/activity help    | pending   | add shopping-list trash lifecycle      |
