...
| L02 shopping                          | in_progress | Named lists, unified sourced items, editable transfer, concurrent check-off and polling     | Hard delete removed lists immediately                  | 18 Logistics + PostgreSQL cleanup green              | shopping help                             | pending   | move individual item deletion to trash |
...
| A01 activity/trash                    | in_progress | Metadata-only feed, soft delete/restore and deterministic 30-day purge                      | Shopping-list hard delete bypassed trash               | 13 Activity + 21 API + 13 React tests green          | Activity context, search/activity help    | pending   | add shopping-item trash lifecycle      |
