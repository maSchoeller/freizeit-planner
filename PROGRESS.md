...
| F02 attachments                       | pending     | Magic-byte/MIME/extension checks, quotas, private authorized image/PDF delivery             | Meal attachments were unreachable from their owner     | 49 React + full gate/mobile meal-file browser        | Files/Catering contexts, meal help        | pending   | Expose files on ScheduleEntry details  |
